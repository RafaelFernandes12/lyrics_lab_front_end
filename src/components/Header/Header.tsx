...
export function Header() {
  ...
  const [storageTheme, setStorageTheme] = useState('black');
  useEffect(() => {
    if(theme === 'dark'){
  ...
  return (
    <header className="flex items-center justify-between">
      <Link href="/">
        <svg width="125" height="65" viewBox="0 0 125 65" fill={`${storageTheme!}`} xmlns="http://www.w3.org/2000/svg">
      ...
      <button onClick={handleThemeSwitch}><span>aqui</span></button>
